-- Re-define notify_n8n_whatsapp_requirement with proper curlopt timeout configuration and lock-free execution order
...
BEGIN
  ...
  -- 5. Configurar el timeout HTTP a 15 segundos usando curlopt para evitar timeouts prematuros de n8n
...
-- Limpieza: Eliminar la función temporal de depuración
DROP FUNCTION IF EXISTS public.notify_n8n_whatsapp_requirement_debug(BIGINT, TEXT);
