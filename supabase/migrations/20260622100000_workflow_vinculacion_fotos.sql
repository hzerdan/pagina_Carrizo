...
DROP FUNCTION IF EXISTS public.procesar_media_buffer_y_generar_pregunta(BIGINT, TEXT);
DROP FUNCTION IF EXISTS public.intentar_procesar_respuesta_requerimiento(BIGINT, TEXT);
DROP FUNCTION IF EXISTS public.rebuild_remito_instrucciones_texto(BIGINT);
...
RETURNS TABLE (
  out_text TEXT,
  out_is_requirement BOOLEAN,
  out_waid TEXT,
  out_profile_name TEXT,
